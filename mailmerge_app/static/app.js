...
const ids = [
  ...
  'templateSelect','templateName','subjectTemplate','bodyTemplate','bodyHtmlEditor','signatureHtmlEditor','placeholderList','snippetList','attachmentList','attachmentFile','newSnippetButton','newTemplateButton','saveTemplateButton','deleteTemplateButton','clearFormattingButton',
...
const tourSteps=[
  ...
  {selector:'.review-card',title:'Preview the personalized result',text:'After you check messages, use this panel to move through recipients and make a last edit when needed.'},
